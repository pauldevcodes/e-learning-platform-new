...
import Image from '../images/desktop-hero.jpg'
const CyberSecurity = () => {
    return (
        <div>
            <section className="md:bg-hero-tablet bg-cover bg-no-repeat lg:bg-about-hero bg-hero-mobile pb-10 min-h-[80vh] relative">
            ...
            <div className="py-20">
                <div className="text-center mx-20">
                    ...
                    <div style={{ backgroundImage: `url(${Image})` }} className="bg-cover bg-no-repeat min-h-[20vh] rounded-md my-10 relative">
                        <div className="absolute bg-black/50 w-full h-full top-0 left-0"></div>
                        <div className="flex md:flex-row flex-wrap justify-around items-center gap-10 py-20">
                            <span className="text-white font-semibold text-lg text-center z-50">
