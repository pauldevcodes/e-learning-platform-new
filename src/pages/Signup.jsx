...
const Signup = () => {
    return (
        <section className=' bg-orange-50 min-h-screen flex flex-col justify-center items-center px-5 py-24 md:px-14'>
            <div className=' grid grid-cols-1 gap-y-5 lg:grid-cols-2 lg:gap-x-5 lg:items-center lg:max-w-screen-lg lg:mx-auto'>
                ...
                <div className=' flex flex-col gap-y-5'>
                    ...
                    <p className=' text-sm text-gray-500 text-center lg:text-base'>
                        Already have an account? <Link className=' text-orange-500'>Sign In</Link>
                    </p>
                </div>
            </div>
        </section>
